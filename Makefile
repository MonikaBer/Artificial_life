...
OBJS = main.cpp Graphics/MainWindow.cpp Subjects/SubjectsCollection.cpp Subjects/Animals/Animal.cpp Subjects/Plants/Plant.cpp Subjects/Animals/Herbivore.cpp Subjects/Animals/Predator.cpp
