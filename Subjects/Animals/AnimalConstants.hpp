...
class AnimalConstants {
    public:
        ...
        static const int PERCENT_OF_REGENERATION = 0.1;
        static const int ESSENTIAL_PERCENT_OF_ENERGY = 0.2;
        static const int ESSENTIAL_PERCENT_OF_FULLNESS = 0.2;
        static const int TEMPERATE_PERCENT_OF_FULLNESS = 0.5;
        static const int TEMPERATE_PERCENT_OF_ENERGY = 0.3;
        static const int SUFFICIENT_PERCENT_OF_FULLNESS = 0.85;
